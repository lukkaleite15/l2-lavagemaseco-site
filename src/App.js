...
// ── Chaves de storage compartilhada ──────────────────────────────────────────
...
const LOGO_B64 = "data:image/jpeg;base64,";

const WA_NUMBER  = "5585987880298";
const WA_DISPLAY = "(85) 98788-0298";
const POLTRONA_B64 = "data:image/png;base64,";
...
// ── Sidebar ───────────────────────────────────────────────────────────────────
function Sidebar({ open, onClose, user, booking, onGoToAuth, onGoToBookingCheck }) {
  ...
  return (
    <div style={pageBg} className="min-h-screen text-zinc-100 flex flex-col justify-between">
      <div>
        ...
        <Sidebar open={sidebarOpen} onClose={()=>setSidebarOpen(false)} user={user} booking={activeBooking}
          onGoToAuth={()=>{ setPage("auth"); setSidebarOpen(false); }}
          onGoToBookingCheck={()=>{ handleGoToBookingCheck(); setSidebarOpen(false); }}/>

        {page==="auth"         && <AuthPage users={users} setUsers={setUsers} onSuccess={handleAuthSuccess} currentUser={user}/>}
...
// ── AuthPage ──────────────────────────────────────────────────────────────────
function AuthPage({ users, setUsers, onSuccess, currentUser }) {
  ...
  function doRegister() {
    ...
    if (users.find(u=>u.email===reg.email)) { setError("E-mail já cadastrado."); return; }
  ...
  function doLogin() {
    ...
    const found = users.find(u=>u.email===log.email);
